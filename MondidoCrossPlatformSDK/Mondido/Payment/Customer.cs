...
namespace Mondido.Payment
{
    public class Customer : BaseModel
    {
        ...
        public static Customer Create(HttpParams data)
        {
		...
		public static IEnumerable<Customer> List(int take, int skip, Dictionary<string,string> filters = null, string sortBy = "id:desc")
        {
        ...
        public static Customer Update(int id, HttpParams data)
        {
